...
set t_Co=256
let g:colors_name = "mookaitlight"

hi Cursor ctermfg=231 ctermbg=130 cterm=NONE guifg=#fffff0 guibg=#b04f2f gui=NONE
hi Visual ctermfg=NONE ctermbg=188 cterm=NONE guifg=NONE guibg=#d6d3cc gui=NONE
hi CursorLine ctermfg=NONE ctermbg=188 cterm=NONE guifg=NONE guibg=#e8e7da gui=NONE
hi CursorColumn ctermfg=NONE ctermbg=188 cterm=NONE guifg=NONE guibg=#e8e7da gui=NONE
hi ColorColumn ctermfg=NONE ctermbg=188 cterm=NONE guifg=NONE guibg=#e8e7da gui=NONE
hi LineNr ctermfg=102 ctermbg=188 cterm=NONE guifg=#8a8684 guibg=#e8e7da gui=NONE
hi VertSplit ctermfg=145 ctermbg=145 cterm=NONE guifg=#bbb9b1 guibg=#bbb9b1 gui=NONE
hi MatchParen ctermfg=130 ctermbg=NONE cterm=underline guifg=#bc310a guibg=NONE gui=underline
hi StatusLine ctermfg=16 ctermbg=145 cterm=bold guifg=#140c17 guibg=#bbb9b1 gui=bold
hi StatusLineNC ctermfg=16 ctermbg=145 cterm=NONE guifg=#140c17 guibg=#bbb9b1 gui=NONE
...
hi IncSearch ctermfg=231 ctermbg=172 cterm=NONE guifg=#fffff0 guibg=#ea781f gui=NONE
hi Search ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Directory ctermfg=52 ctermbg=NONE cterm=NONE guifg=#430c07 guibg=NONE gui=NONE
hi Folded ctermfg=137 ctermbg=231 cterm=NONE guifg=#b48859 guibg=#fffff0 gui=NONE

hi Normal ctermfg=16 ctermbg=231 cterm=NONE guifg=#140c17 guibg=#fffff0 gui=NONE
...
hi DiffAdd ctermfg=16 ctermbg=149 cterm=bold guifg=#140c17 guibg=#a1e85a gui=bold
hi DiffDelete ctermfg=203 ctermbg=NONE cterm=NONE guifg=#f25451 guibg=NONE gui=NONE
hi DiffChange ctermfg=16 ctermbg=152 cterm=NONE guifg=#140c17 guibg=#b9cfe0 gui=NONE
...
hi NonText ctermfg=230 ctermbg=230 cterm=NONE guifg=#feffea guibg=#f3f3e5 gui=NONE
...
hi SpecialKey ctermfg=230 ctermbg=188 cterm=NONE guifg=#feffea guibg=#e8e7da gui=NONE
